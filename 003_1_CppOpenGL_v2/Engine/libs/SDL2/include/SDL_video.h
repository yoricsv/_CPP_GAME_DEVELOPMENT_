 ...
 *
 * In some cases (e.g. OpenGL) and on some platforms (e.g. Microsoft Window)
 ...
 * specific behavior (for example, on Window, this certainly might fire when
 ...
 *
 * - On Window, function pointers are specific to the current GL context;
 *   this means you need to have created a GL context and made it current
 *   before calling SDL_GL_GetProcAddress(). If you recreate your context or
 *   create a second context, you should assume that any existing function
 *   pointers aren't valid to use with it. This is (currently) a
 *   Window-specific limitation, and in practice lots of drivers don't suffer
 ...
 *
 * Window users new to OpenGL should note that, for historical reasons, GL
 ...
 *
 * and for some Window drivers with WGL_EXT_swap_control_tear:
 *
